...
form.addEventListener('submit', function(e) {
  ...
  // Check if the user is new or an existing user to be updated
  const userIndex = userList.findIndex(function(u) {
...
function displayUsers() {
  ...
  // Loop through each user in the list and create a new LI element with Edit and Delete buttons
  userList.forEach(function(user, index) {
    const li = document.createElement('li');
    li.textContent = user.name + ' - ' + user.email;
    ...
    editButton.addEventListener('click', function() {
      // Fill the form with the user's details to be edited
    ...
    // Add the Edit and Delete buttons to the LI element
